...
const locationDriver: DataLocationGooglePlace = {
  postal: '3001',
  place_id:
    'EkFBdmVuaWRhIEFuZHJlcyBCZWxsbyAmIENhcnJlcmEgMzFBLCBCYXJxdWlzaW1ldG8sIExhcmEsIFZlbmV6dWVsYSJmImQKFAoSCU1ajlKgZ4eOEbeKp4_P8QPFEhQKEglNWo5SoGeHjhG3iqePz_EDxRoUChIJoyRCraFnh44R-xhIcVdQxJoaFAoSCfkpgfugZ4eOEVt99AhqhMZDIgoNGuQBBhWhia_W',
  description:
    'Avenida Andres Bello & Carrera 31A, Barquisimeto 3001, Lara, Venezuela',
...
export const Travel = ({navigation}: StackScreenProps<any, any>) => {
  ...
  const [historyCycleDriver, setHistoryCycleDriver] =
    useState<HistoryDriverCycle>('');

  const [locationsDriver, setLocationsDriver] = useState<
